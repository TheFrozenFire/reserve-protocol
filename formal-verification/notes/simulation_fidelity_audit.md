...
The two highest-deployment plugins are now modeled as plugin-specific
simulation modules — see the `CTokenFiatCollateral` and
`CurveStableCollateral` sections below. Other deployed plugins
